...
const DashboardLayout = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col lg:flex-row">
            ...
            {/* Sidebar Drawer - Mobile + Sticky Sidebar - Large */}
            <div
                className={` ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'} 
                    fixed inset-y-0 left-0 w-64 bg-white shadow-xl z-50 border-r border-gray-200 transition-transform duration-300 ease-in-out
            ...
            >
                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center space-x-3 p-3 bg-gradient-to-r from-blue-50 to-orange-50 rounded-lg">
                        {user?.photoURL ? (
                            <img src={user.photoURL} alt={user.displayName} className="w-12 h-12 rounded-full object-cover border-2 border-white shadow-sm" />
                        ) : (
                            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-400 to-orange-400 text-white text-lg font-bold border-2 border-white shadow-sm uppercase">
