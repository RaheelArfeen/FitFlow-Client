            ...
            <div className="md:container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-6">
                                ...
                                <span className="block text-orange-600">One Journey at a Time</span>
                            </h2>
                            <p className="text-lg text-gray-600 leading-relaxed mb-6">
                                At FitFlow, we believe fitness is more than just exercise—it's a lifestyle transformation.
                                Our platform combines cutting-edge technology with personalized human touch to create
                    ...
                    <div className="relative">
                        <div className="aspect-square bg-gradient-to-br from-blue-100 to-orange-100 rounded-full absolute -top-4 -right-4 w-72 h-72 opacity-50"></div>
                        <div className="relative">
                            <img
