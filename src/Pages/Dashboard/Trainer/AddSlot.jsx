...
const AddSlot = () => {
    ...
    return (
        <motion.div
            ...
            animate="visible"
            variants={containerVariants}
            className='p-6 md:p-8 bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100'
        >
            ...
            >
                ...
                >
                    ...
                    <div className="flex flex-col">
                        <motion.h3 variants={itemVariants} className="font-semibold text-gray-800 dark:text-white">
                        ...
                        <motion.p variants={itemVariants} className="text-sm text-gray-500 dark:text-gray-500">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                        <motion.div variants={itemVariants}>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
                        ...
                        <motion.div variants={itemVariants} className="relative" ref={dayDropdownRef}>
                            ...
                            <div
                                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-700 cursor-pointer focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                onClick={() => setIsDayDropdownOpen(!isDayDropdownOpen)}
                            >
                                <div className='flex items-center justify-between'>
                                    <div className='flex items-center gap-2'>
                                        <Calendar className="h-5 w-5 text-gray-400 dark:text-gray-500" />
                                        <span className='text-gray-800 dark:text-white'>{formData.selectedDay || "Choose a day"}</span>
                                    </div>
                                    <ChevronDown className={`h-5 w-5 text-gray-400 dark:text-gray-500 transform transition-transform ${isDayDropdownOpen ? 'rotate-180' : 'rotate-0'}`} />
                                </div>
                            </div>
                            <AnimatePresence>
                                {isDayDropdownOpen && (
                        ...
                        <motion.div variants={itemVariants}>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-800 dark:text-white"
                        ...
                        <motion.div variants={itemVariants} className="relative" ref={classDropdownRef}>
                            ...
                            <div
                                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-700 flex items-center justify-between cursor-pointer focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                onClick={() => setIsClassDropdownOpen(!isClassDropdownOpen)}
                            >
                                <div className='flex items-center gap-2'>
                                    <BookOpen className="h-5 w-5 text-gray-400 dark:text-gray-500" />
                                    <span className='text-gray-800 dark:text-white'>{formData.selectedClass || "Select a class"}</span>
                                </div>
                                <ChevronDown className={`h-5 w-5 text-gray-400 dark:text-gray-500 transform transition-transform ${isClassDropdownOpen ? 'rotate-180' : 'rotate-0'}`} />
                            </div>
                            <AnimatePresence>
                                {isClassDropdownOpen && (
                                    <motion.ul
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center justify-between mb-4">
                                    <div>
                                        <h4 className="text-xl font-semibold text-gray-800 dark:text-white">{formData.slotName}</h4>
                                        <p className="text-gray-600 dark:text-gray-400">{formData.selectedClass || 'Class not selected'}</p>
                                    </div>
                    ...
                    >
                        ...
                        <motion.button
                            ...
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="flex items-center space-x-2 bg-blue-700 hover:bg-blue-800 text-white dark:bg-blue-600 dark:hover:bg-blue-700 px-6 py-3 rounded-lg transition-colors duration-200"
                            disabled={addSlotMutation.isPending}
                        >
